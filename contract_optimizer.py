...
## realtime assump modal --> modal_simulation_realtime_assump.py
## input modal --> modal_simulation_input.py
## measure selection modal --> modal_simulation_measure_selection.py
## contract_optimizer main page
'''
...
## end of measure selection modal


## callbacks on contarct_optimizer main page 

### Contract Simulation Setup Tab

# using realtime assump modal input calculate recommend value for each cohort and store temp realuts in hidden div
@app.callback(
...
# auto select recommend patient cohort based on realtime assump modal input
@app.callback(
...
# select measures depend on target-patient-input value and realtime assump modal input
	# in this demo, only domin1-1, domian1-3 and domain2-1 matters. for final product, all domains should be included.
@app.callback(
...
# show measures selected from measure selection modal in the table
	# pre-selected measures will change depend on setting in realtime assump modal and value of target-patient-input
@app.callback(
...
def update_table(d1,d2,d3,d4,d5,d6,mc1,mc2,mc3,mc4,mc5,mc6,mc7,mc8,mc9,mc10,mc11,cohort):
...
# editable dash table
	# calculate weight based on user input data
@app.callback(
...
# simulation calculation, show results on result tab 
@app.callback(
